...
namespace actions
{
    absl::StatusOr<std::unique_ptr<Connection>> Connection::Open()
    {
        ...
        const xcb_query_extension_reply_t *xtest_data = xcb_get_extension_data(conn, &xcb_test_id);
    ...
    absl::Status Connection::SendKeystroke(Keystrokes& keystrokes)
    {
        ...
        //     xcb_test_fake_input(conn, XCB_KEY_PRESS, code, 0, screen->root, 0, 0, 0);
        //     xcb_test_fake_input(conn, XCB_KEY_RELEASE, code, 0, screen->root, 0, 0, 0);
        ...
        for (Keystroke keystroke : keystrokes) {
            ...
            cookies.push_back(xcb_test_fake_input_checked(conn, XCB_KEY_PRESS, code, 0, screen->root, 0, 0, 0));
            cookies.push_back(xcb_test_fake_input_checked(conn, XCB_KEY_RELEASE, code, 0, screen->root, 0, 0, 0));
        }
